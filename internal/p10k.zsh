    ...
    if [[ -n $VCS_STATUS_ACTION ]]; then
      ...
      if [[ $VCS_STATUS_HAS_STAGED == 1 || $VCS_STATUS_HAS_UNSTAGED == 1 || $VCS_STATUS_HAS_UNTRACKED == 1 ]]; then
        ...
        if [[ $VCS_STATUS_HAS_STAGED == 1 ]]; then
          ...
          # echo "_P9K_STAGED_NUM: $(fmter $_P9K_STAGED_NUM)"
          _$0_fmt STAGED " $_p9k__ret$(fmter $_P9K_STAGED_NUM)"
        fi
        if [[ $VCS_STATUS_HAS_UNSTAGED == 1 ]]; then
          ...
          # echo "_P9K_UNSTAGED_NUM: $(fmter $_P9K_UNSTAGED_NUM)"
          _$0_fmt UNSTAGED " $_p9k__ret$(fmter $_P9K_UNSTAGED_NUM)"
        fi
        if [[ $VCS_STATUS_HAS_UNTRACKED == 1 ]]; then
          ...
          # echo "_P9K_UNTRACKED_NUM: $_P9K_UNTRACKED_NUM"
          _$0_fmt UNTRACKED " $_p9k__ret$(fmter $_P9K_UNTRACKED_NUM)"
        fi
      fi
